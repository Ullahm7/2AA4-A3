...
public class Initializer {
    ...
    public String initializeMission(Heading initialHeading, Storage responseStorage) {
    ...
    // dimension
    private String determineNextDimension(Storage responseStorage) {
        if (counter == 0) {
            counter++;
    ...
    public String initialThreeCheck(Storage responseStorage) {
        if (counter == 0) {
    ...
    // coordinate
    public String findMissingCoordinate(Storage responseStorage) {
        if (!responseStorage.getFound().equals("OUT_OF_RANGE")) {
            if (counter == 0) {
                counter++;
                flyCounter++;
